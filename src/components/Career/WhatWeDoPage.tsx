...
function WhatWeDoPage() {
  ...
  return (
    <div id="what-we-do" className="min-h-screen mt-20">
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-white text-center animate-fadeIn">
          <div className="max-w-3xl mx-auto">
            <div className="w-20 h-1 bg-[#00F1FF] mb-6 mx-auto"></div>
      ...
      {/* Mission Section */}
      <section className="py-20 bg-gradient-to-b from-[#F4F5F9] to-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/5 backdrop-blur-md border border-[#00F1FF]/20 rounded-2xl p-8
                             hover:-translate-y-2 hover:shadow-[0_0_25px_rgba(0,241,255,0.3)]
                             transition-all duration-500 ease-out animate-slideUp delay-[200ms]"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-[#4E00FF] to-[#00F1FF] rounded-xl flex items-center justify-center mb-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-slideInRight">
              ...
              <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-[#00F1FF] rounded-lg blur-2xl opacity-60 -z-10"></div>
              <div className="absolute -top-6 -left-6 w-40 h-40 bg-[#4E00FF] rounded-lg blur-2xl opacity-60 -z-10"></div>
            </div>
          </div>
        </div>
      </section>
